...
export const startNovelPlay = (previewToken: string, signal?: AbortSignal) => api<{ started: { card: string; session: "created" } }>("/api/novel-play/start", { method: "POST", body: JSON.stringify({ previewToken }), signal });
